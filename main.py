...
from test_bs import test, test_prcc
...
def main(config):
    ...
    criterion_cla, criterion_pair, criterion_clothes, criterion_adv, kl, recon_cloth, recon_uncloth, recon_contour = build_losses(config, dataset.num_train_clothes)
    # Build optimizer
    ...
    for epoch in range(start_epoch, config.TRAIN.MAX_EPOCH):
        ...
        if config.LOSS.CAL == 'calwithmemory':
            ...
            train_cal(config, epoch, model, model2, fuse, classifier, clothes_classifier, clothes_classifier2,criterion_cla, criterion_pair, 
