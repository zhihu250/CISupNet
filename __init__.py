...
def build_losses(config, num_train_clothes):
    # Build identity classification loss 分类id的损失
    ...
    return criterion_cla, criterion_pair, criterion_clothes, criterion_cal, kl, recon_cloth, recon_uncloth, recon_contour
