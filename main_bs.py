...
from train_bs import train_cal, train_cal_with_memory
...
def parse_option():
    ...
    parser.add_argument('--cfg', type=str, default='configs/res50_cels_cal.yaml', metavar="FILE", help='path to config file')
    # Datasets
...
def main(config):
    ...
    criterion_cla, criterion_pair, criterion_clothes, criterion_adv, kl, recon_cloth = build_losses(config, dataset.num_train_clothes)
    # Build optimizer
